...
**Alunos:** Bruno Bandeira, Daniel Ferreira, Enzo Trindade e Heitor de Lima
...
Antes de começar a criar as telas no App Inventor, o grupo deveria primeiro pensar no que realmente será necessário para o aplicativo.

- **Quem vai usar o aplicativo:** nesse caso, seriam os alunos. Isso é importante para criar algo que seja fácil de entender e usar.
- **Qual problema o aplicativo vai resolver:** ajudar os alunos a organizar trabalhos, provas e atividades.
- **Quais informações serão guardadas:** como o nome da atividade, a matéria e a data de entrega.
- **Quais funções o aplicativo terá:** por exemplo, cadastrar, visualizar, excluir e marcar atividades como concluídas.
- **Como serão as telas:** pensar na organização das informações e em como o usuário vai navegar pelo aplicativo.

Essas decisões são importantes porque evitam começar o projeto sem saber exatamente o que precisa ser feito.
...
Esses testes ajudam a encontrar erros antes que o aplicativo seja utilizado pelos usuários.
